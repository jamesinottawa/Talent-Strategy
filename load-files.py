...
applications = glob("O:\Talent Strategy - To process\Conference Applications/2017Q4/*.xlsm")
dsas = glob("O:\Talent Strategy - To process\DSA Applications/2017Q4/*.xlsm")
quarter = "2017Q4"
save_file = "C:/Users/chja/Desktop/new_temp_ts_2017Q4.xlsx"
...
def read_dsa_sheet(file_name, quarter):
    ...
    visits.columns = ["visit_number", "visit_start", "visit_end", "work_days",
                      ...
                      "transport", "hotel", "meal", "hospitality",
                      "other", "total"]
...
# trips
app_data_order = ["Approve", 'dept', 'authors','paper_title', 'Conf_name',
                  ...
                  'recent_quarter']
header_names = ["Approve", 'Dept', 'Authors','Paper', 'Conference', 
...
# dsas
dsa_data_order = ["Approve", 'DSA_name', 'applicant', 'department','total',
